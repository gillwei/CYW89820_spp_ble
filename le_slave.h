...
#define HCI_ROLE_MASTER	HCI_ROLE_CENTRAL
#define HCI_ROLE_SLAVE	HCI_ROLE_PERIPHERAL
...
wiced_result_t le_slave_send_service_discovered_result(const uint16_t conn_id, const char* uuid, const uint16_t start_handle, const uint16_t end_handle);
wiced_result_t le_slave_send_characteristic_discovered_result(const uint16_t conn_id, const uint8_t* uuid, const uint16_t characteristic_handle, const uint16_t value_handle);
wiced_result_t le_slave_send_descriptor_discovery_result(const uint16_t conn_id, const uint8_t* uuid, const uint16_t descriptor_handle);
wiced_result_t le_slave_send_discovery_complete(const uint16_t conn_id);
wiced_result_t le_slave_send_write_response(const uint16_t conn_id, const uint16_t attr_handle, const uint8_t  result);
#endif
