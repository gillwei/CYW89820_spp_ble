...
static void wiced_bt_send_test_command( uint16_t opcode, uint8_t* params, uint8_t params_length )
{
    ...
    WICED_BT_TRACE ( "opcode %02x,params:%02x, params_length:%d \n\r", opcode, params[0], params_length );
    ...
    else
    {
        ...
        {
        	WICED_BT_TRACE ( "p_command is null \n\r" );
        ...
        p_command->offset = 0;
        WICED_BT_TRACE ( "p_command layer_specific:%02x\n\r", p_command->layer_specific );
