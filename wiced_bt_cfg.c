...
uint8_t BT_LOCAL_NAME[] = { 'G','I','N','K','C','A','R','D','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .ble_advert_cfg =                                               /* BLE advertisement settings */
    {
        ...
        .high_duty_duration              = 0/*60*/,                                                         /**< High duty undirected connectable advertising duration in seconds (0 for infinite) */
        ...
        .high_duty_nonconn_duration      = 0/*30*/,                                                         /**< High duty non-connectable advertising duration in seconds (0 for infinite) */
    ...
    .rfcomm_cfg =                                                   /* RFCOMM configuration */
    {
        ...
        .max_ports                      = 3/*2*/                                                            /**< Maximum number of simultaneous RFCOMM ports */
    },
    ...
    .addr_resolution_db_size            = 8,                                                           /**< LE Address Resolution DB settings - effective only for pre 4.2 controller*/
    ...
    .rpa_refresh_timeout                = 180,	//WICED_BT_CFG_DEFAULT_RANDOM_ADDRESS_NEVER_CHANGE,            /**< Interval of  random address refreshing - secs */
#if 1	//SDK v3.0.0
...
/*  { buf_size, buf_count, }, */
    { 64,       16,        }, /* Small Buffer Pool */
    { 360,      (40-1),         }, /* Medium Buffer Pool (used for HCI & RFCOMM control messages, min recommended size is 360) */
    { 1056,     6,         }, /* Large Buffer Pool  (used for HCI ACL messages) */
    { (1056+360),     1,         }, /* Extra Large Buffer Pool (used for SDP Discovery) */
#endif
